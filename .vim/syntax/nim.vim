" Originally based on https://github.com/zah/nim.vim/blob/7a8737a4532239c06116ebde0329d8156f3d3b55/syntax/nim.vim
" Modified to ignore very old vim versions and tweak highlighting
...
if nim_highlight_builtins == 1
  ...
  syn keyword nimType bool void chr char string cstring pointer range array openarray openArray seq varargs varArgs
...
hi def link nimFunction Special
...
" This is a hack, the colour for PmenuSel in ron happens to be a good one
hi def link nimComment PmenuSel
